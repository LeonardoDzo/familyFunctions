...
exports.eventMembersChanged = functions.database.ref('/events/{id}/members')
    .onWrite((event) => __awaiter(this, void 0, void 0, function* () {
    let id = event.params.id;
    let members = event.data.val() || [];
    let oldMembers = event.data.previous.val() || [];
...
exports.listenerEvent = functions.database.ref('events/{id}/').onCreate((event) => __awaiter(this, void 0, void 0, function* () {
